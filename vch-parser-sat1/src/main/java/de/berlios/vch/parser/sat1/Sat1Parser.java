package de.berlios.vch.parser.sat1;
...
@Component
@Provides
public class Sat1Parser implements IWebParser {
    public static final String CHARSET = "UTF-8";

    public static final String ID = Sat1Parser.class.getName();

    private static final String BASE_URI = "http://sat1_api.cellmp.de";
    private static final String CATEGORY_URI = BASE_URI + "/1.0/getCategories.php?device=android";
    private static final String PROGRAM_URI = BASE_URI + "/1.0/getClips.php?device=android&category=";
    ...
    public IOverviewPage getRoot() throws Exception {
        ...
        for (int i = 0; i < programs.length(); i++) {
            ...
            category.setUri(new URI("sat1://category/" + program.getString("id")));
    ...
    public IWebPage parse(IWebPage page) throws Exception {
        ...
        if (pageUri.toString().contains("episode")) {
            ...
            for (int i = 0; i < episodes.length(); i++) {
                ...
                video.setUri(new URI("sat1://category/" + categoryId + "/episode/" + episodeId));
