...
public class DeleteDownload extends VchrAsyncTask<String, Void, String> {

    public DeleteDownload(Context ctx) {
        super(ctx);
    }
    ...
    protected String doTheWork(String... id) throws Exception {
        ...
        String request = downloadsUri + "?action=delete&id=" + id[0];
