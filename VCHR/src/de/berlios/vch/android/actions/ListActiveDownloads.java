...
public class ListActiveDownloads extends Action {

    private String downloadsUri;
    private ActiveDownloadsAdapter adapter;
    
    public ListActiveDownloads(String downloadsUri, ActiveDownloadsAdapter adapter) {
    ...
    public void execute() throws Exception {
        String requestUri = downloadsUri + "?action=list&list=active";
