...
public class MMSDownload extends AbstractDownload implements MMSMessageListener, MMSPacketListener, IoHandler {
    ...
    private static transient Logger logger = LoggerFactory.getLogger(MMSDownload.class);
    ...
    private void extractConnectInfo() {
        ...
        logger.trace(host);
        logger.trace(Integer.toString(port));
        logger.trace(path);
        logger.trace(file);
    }
    ...
    public void startDownload() {
        ...
        if (getOutputStream() == null) {
            if (getLocalFile() != null) {
                ...
                logger.debug("Local file and output stream is null. Data will be discarded");
            }
        }
    ...
    public void cancel() {
        ...
        if(localFile != null && localFile.exists()) {
            ...
            if(!deleted) {
                logger.warn("Couldn't delete file " + localFile.getAbsolutePath());
            }
        }
        
        // delete the nfo file
        deleteInfoFile(localFile);
    }
