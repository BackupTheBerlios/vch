...
public class RssParser {
    ...
    public static SyndFeed parse(String uri) throws IllegalArgumentException, MalformedURLException, FeedException, IOException {
        ...
        for (SyndEntry entry : entries) {
            ...
            if(group.getMetadata() != null && group.getMetadata().getThumbnail() != null) {
                ...
                if(thumbs.length > 0) {
                    ...
                    myvidcast.setImage(thumb.getUrl().toString());
